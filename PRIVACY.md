...
The app stores the following preferences locally on your device only:

- Difficulty level setting
- Show/hide color values preference
- Target shape preference
- First launch tutorial preference
